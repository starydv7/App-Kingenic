...
const PlantProtein = () => {
  ...
  const brandNames = [
    ...
    { name: "Nutraceutical ", screen: "NutraScreen" },
  ...
  const handleBrandPress = (index, screen) => {
          ...
          <View style={styles.scrollright}>
            ...
            >
              {brandNames.map((brand, index) => (
                 ...
                 style={[
                   styles.brandItem,
                   activeBrandIndex === index && styles.activeBrandItem, // Apply active styles conditionally
                 ]}
                 onPress={() => handleBrandPress(index, brand.screen)}
               >
